...
("Quentin Tarantino", "Estados Unidos", '1963-03-27', 'M');
...
INSERT INTO tbl_filme (nome_filme, ano_lancamento, duracao, FK_id_genero, FK_id_diretor) VALUES 
("Bastardos Inglorios", 2009, 153, 2, 8);


select * from tbl_filme;

select min(ano_lancamento) from tbl_filme;
select max(ano_lancamento) from tbl_filme;

select count(id_genero) from tbl_genero;
